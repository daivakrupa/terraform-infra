...
module "alb_listener" {
  ...
  http_action_type      = "forward"
  enable_https_listener = false  # Dev: No HTTPS for simplicity
}
...
resource "aws_cloudwatch_log_group" "ecs_tasks" {
  ...
  retention_in_days = 7  # Dev: Short retention
...
module "frontend_bucket" {
  ...
  force_destroy            = true  # Dev: Allow bucket deletion
...
module "cloudfront" {
  ...
  # Dev: Use default CloudFront certificate
}